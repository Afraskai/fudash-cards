...
- **`fudash-stat-card`** – kompakte KPI-Kachel mit großer Einzelzahl,
  Trend-Sparkline (Linie oder Balken, live umschaltbar), Delta-Chip
  (Vergleich zum Zeitraum-Anfang) und optionaler Min/Ø/Max-Zeile.
...
> **Hinweis zur Sprache:** Die Editor-Oberfläche und alle UI-Texte sind
> ab Version 0.11 auf **Englisch**, damit die Karten in der weltweiten
> HA-Community ohne Sprachbarriere funktionieren. Diese deutsche
> Dokumentation bleibt parallel verfügbar.
...
| `center_label`  | String  | `Total` | Untertitel unter dem Center-Wert. |
...
| `hours`            | Zahl    | `24`    | Zeitraum für Trend, Delta-Referenz und Min/Ø/Max (1–168 h). |
...
| `show_stats`       | Bool    | `true`  | Min/Ø/Max-Footer unter der Sparkline. |
